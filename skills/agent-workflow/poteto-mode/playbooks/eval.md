...
- The candidate prompt looks like an organic user request. State the goal, not the meta-framing. "build me a small todo cli" not "show me how you follow the principles chain".
